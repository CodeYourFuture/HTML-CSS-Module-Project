...
### Tasks
 ...
 - **Fork and clone** this repo.
  ...
  Now you should be on your own Github repository - you'll know this because your name should nowour own Karma repository on Github (which was created when you be in the repo name at the top of the Github page. 
   - To clone, click the green button that says 'Code' on that page.
  Now the code is on your own machine (this happened when you cloned), AND it's linked to y forked).
